...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {   
                ...
                var url="quantityAjax.jsp?id="+10;
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>Chaar kadam</h1></div><br><br><br><br>
                <img src="image/10.jpg" class="productImage"/><br/>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Anushka Sharma, Sushant Singh Rajput</td>
                    </tr>
                    <tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="10"/> 
