...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {   
                ...
                var url="quantityAjax.jsp?id="+14;
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>Kabeera Maan Ja</h1></div><br><br><br><br>
                <img src="image/14.jpg" class="productImage"/><br/>
                <table>
                    <tr>
                    ...
                    <br /><br />
                <div class="price"> Rs. 38 </div>    
 <c:if test="${sessionScope.LoginID ne null}">
                    <center>
                    <form action="addToCart.action" method="POST" class="buyNow"><br/>
                    <input type="hidden" name="DiskID" value="14"/> 
