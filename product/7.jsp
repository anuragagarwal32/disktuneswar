...
<html>
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>2 Number</h1></div><br><br><br><br>
                <img src="image/7.jpg" class="productImage"/><br/>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Amrinder Gill, Bilal Saeed</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>punjabi song from Amrinder gill</td>
                    </tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="7"/> 
