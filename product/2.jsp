...
<html>
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>Mitran de boot</h1></div><br><br><br><br>
                <img src="image/2.jpg" class="productImage"/><br/>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> Jazzy B ,Dr Zeus ,Kaur B ,Surveen Chawla </td>
                    </tr>
                    <tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="2"/> 
