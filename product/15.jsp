...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {   
                ...
                var url="quantityAjax.jsp?id="+15;
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>Sandase aate Hain </h1></div><br><br><br><br>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>sunny deol, sunil shetty, akshay khanna</td>
                    </tr>
                    <tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="15"/> 
