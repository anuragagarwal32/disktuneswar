...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {   
                ...
                var url="quantityAjax.jsp?id="+16;
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>Sawaree</h1></div><br><br><br><br>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>Saif ali Khan, Katrina Kaif</td>
                    </tr>
                    <tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="16"/> 
