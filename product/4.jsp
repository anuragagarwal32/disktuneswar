...
<html>
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>Laden</h1></div><br><br><br><br>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td> Jassi Gill & Himanshi</td>
                    </tr>
                    <tr>
                        <td class="fCol">Director</td>
                        <td>Arvinder Khaira & Navjit Buttar</td>
                    </tr>
                    <tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="4"/> 
