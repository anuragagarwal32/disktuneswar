...
<html>
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>Abhi Mujhme Kahi</h1></div><br><br><br><br>
                <img src="image/5.jpg" class="productImage"/><br/>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>hrithik roshan,Priyanka Chopra, Sanjay Dutt</td>
                    </tr>
                    <tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="5"/> 
