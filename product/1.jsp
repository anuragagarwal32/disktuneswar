...
<html>
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <div class="product">    
            <div class="songNameFinal"><h1>Neendran</h1></div><br><br><br><br>
                <img src="image/1.jpg" class="productImage"/><br/>
                <table>
                    <tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="1"/> 
