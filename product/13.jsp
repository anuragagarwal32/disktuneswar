...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {   
                ...
                var url="quantityAjax.jsp?id="+13;
   ...
   <c:if test="${sessionScope.LoginID ne null}">
        ...
        <c:if test="${sessionScope.LoginID eq null}">
            ...
            <div class="songNameFinal"><h1>Akhiyan</h1></div><br><br><br><br>
                <img src="image/13.jpg" class="productImage"/><br/>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Diljit Dosanjh, Neeru Bajwa</td>
                    </tr>
                    <tr>
 ...
 <c:if test="${sessionScope.LoginID ne null}">
                    ...
                    <input type="hidden" name="DiskID" value="13"/> 
